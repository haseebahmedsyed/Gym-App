...
function PendingOrders(props) {
    ...
    const { getPendingOrders, PendingOrders, UpdateOrderStatus } = context;
    ...
    return (
        <>
            <h1 style={{marginBottom:'47px',marginTop:'25px',textAlign: 'center'}}>Pending Orders</h1>
                        ...
                        PendingOrders.map((user) => {
                            return <>
                                <tr>
                                    ...
                                    <td rowSpan={user.Items.length}><i onClick={() => UpdateOrderStatus(user.ShoppingID)} class="fa fa-paper-plane" aria-hidden="true"></i>
